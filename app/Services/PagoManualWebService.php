...
class PagoManualWebService
{
    ...
    public function creditCard($carritoDetalle, $token, $carrito)
    {
        ...
        try {
            ...
            curl_setopt($ch, CURLOPT_URL, 'https://scl-sandbox.dev.clover.com/v1/charges'); //sandbox
            ...
            $headers[] = 'Authorization: Bearer 4b1a57e9-6b86-657b-ed7d-be2c0511175c'; //sandbox
